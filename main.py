...
@app.post(
    ...
    tags=["Persons"],    # Ordena las etiquetas en un arreglo en comun.
    summary="Create Person in the app"    # Le coloca el nombre a la funcion.
    )
...
@app.get(
    ...
    status_code=status.HTTP_200_OK,
    tags=["Persons"],
    deprecated=True     # Esta path operation queda sin efecto
    )
def show_person(
